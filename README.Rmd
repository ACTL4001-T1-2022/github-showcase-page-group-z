...
3.  Inputs the differences in position scores (See ![](data/match_model_data.xlsx)) into a GBM that outputs the probability of winning the matchup
4.  Repeat the procedure between Rarita and other teams (See ![](data/match_model_data_rarita.xlsx)).
