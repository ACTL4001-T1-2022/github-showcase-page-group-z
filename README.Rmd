...
```{r linear_regression_models, include = T}
# LINEAR REGRESSION
...
``` {r Standardised_Graphs, include = TRUE}
#FW
...
1. Determines a team’s position score by averaging
standardised salaries over each player position.
2. Calculates the difference between two competing team’s position scores.
3. Inputs the differences in position scores (**TODO: Insert excel hyperlink to match_model_data.xlsx**) into a GBM that outputs the probability of winning the matchup
...
```{r simulations_cont, include = FALSE}
...
For additional information regarding our implementation plan, please refer to **TODO: Add link to report pdf**



# Risk and Risk Mitigation Considerations
The project is subject to various risks impacting the likelihood of successful implementation. For additional information regarding risk analysis, please refer to **TODO: Add link to report pdf**
