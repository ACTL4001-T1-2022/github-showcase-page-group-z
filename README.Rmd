...
```{r linear_regression_models, warning=FALSE, include = FALSE}
# LINEAR REGRESSION
...
**TODO: ADD CODE**
![](Markdown_Figures/Annualized_Salary_Boxplot.png)
...
```{r FW_Player_Rating, include = TRUE}
...
```{r MF_Player_Rating, include = TRUE}
...
```{r DF_Player_Rating, include = TRUE}
...
```{r GK_Player_Rating, include = TRUE}
#GK model
