...
3. Inputs the differences in position scores (See ![data/match_model_data.xlsx](data/match_model_data.xlsx)) into a GBM that outputs the probability of winning the matchup
4. Repeat the procedure between Rarita and other teams (See ![data/match_model_data_rarita.xlsx](data/match_model_data_rarita.xlsx)).
...
The following sensitivity analysis allows for an understanding of the alternative scenarios and the boundaries for negative NPV. See our full report for details ![](ACTL4001_Group_Z_Case_Report%20Submission.pdf).

![](Graphs/sensitivity%201.png)
![](Graphs/sensitivity%202.png)
...
=======
For additional information regarding our implementation plan, please refer to ![Report.pdf](ACTL4001_Group_Z_Case_Report Submission.pdf).
>>>>>>> main
...
<<<<<<< HEAD
The remaining assets will be invested into the Vanguard Balanced Index Fund as it provides the
project with a diverse and stable exposure to domestic equities, international equities, domestic fixed interest and international fixed interest securities.
...
For additional information regarding our implementation plan, please refer to ![](ACTL4001_Group_Z_Case_Report%20Submission.pdf)
...
The project is subject to various risks impacting the likelihood of successful implementation. For additional information regarding risk analysis, please refer to ![Report.pdf](ACTL4001_Group_Z_Case_Report Submission.pdf).
>>>>>>> main
